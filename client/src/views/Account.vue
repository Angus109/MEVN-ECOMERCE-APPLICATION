  ...
  <div class="max-lg:p-5 relative flex flex-col w-full h-fit p-10 bg-[#fafafa] pt-10 rounded-[8px] py-5">
    <header class="max-lg:flex-col flex gap-2 justify-between w-full pb-5">
      ...
      <div class="flex gap-2 sticky top-0">
        ...
        <!-- <AButton title="Create" class="w-fit h-fit py-2 px-3 text-white bg-blue-500" >
          <template #left>
      ...
      <div class="relative">
        ...
        <div class="w-[120px] h-[120px] overflow-hidden rounded-full absolute -bottom-[70px] left-10 object-cover">
          ...
          <img
            ...
            alt=""
          />
          <img  class="w-full h-full rounded-full object-cover"  alt="" />
          <input ref="inputFileElement" type="file" accept="image/*"  />
        </div>
      </div>
        ...
        <div class="w-full flex flex-col mt-4 gap-3">
          ...
          <div  class="w-full border-[1px] rounded-lg p-4">
            <div class="flex w-full justify-between">
              <p class="font-semibold text-primary-200"></p>
              <div>
            ...
            <div class="mt-2">
              <p class="text-base flex items-center gap-2 font-medium">
                <i class="ri-map-pin-2-fill text-xl text-secondary-100"></i> 
              </p>
              <p class="text-base mt-2 flex items-center gap-2 font-medium">
                <i class="ri-user-fill text-xl text-secondary-100"></i> 
              </p>
              <p class="text-base mt-2 flex items-center gap-2 font-medium">
                <i class="ri-phone-fill text-xl text-secondary-100"></i> 
              </p>
            </div>
          </div>
