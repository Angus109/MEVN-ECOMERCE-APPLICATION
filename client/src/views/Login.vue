    ...
    ">
      ...
      ">
        ...
        <div class="flex justify-center">
          <svg xmlns="http://www.w3.org/2000/svg" width="80%" viewBox="0 0 751.57 539.42" xmlns:xlink="http://www.w3.org/1999/xlink">
          <path
...
export default {
  ...
  methods: {
    ...
    async logUserIn() {
      ...
      this.isLoading = true; // Set loading state to true before request
